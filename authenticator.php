...
require_once "config.php";
    if(!isset($_SESSION["code_access"]) || $_SESSION["code_access"] !== true){
        ...
        $sql = "INSERT INTO code (user_id, code, create_at, expiration) VALUES('$user_id', '$codee', '$currentDate', '$packageEndDate')";
...
<head>
    ...
    <body style="background-color:gray;">
            <div class="modal fade" id="myModal" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="hh" class="modal-title">ENTER AUTHENTICATION CODE</h4>
                ...
                <div class="form-group">
                   <center> <center><button type="submit" id="btn1" name="login" class="btn btn-primary">SUBMITtt</button><BR></center>
                </div>
                  </div>
